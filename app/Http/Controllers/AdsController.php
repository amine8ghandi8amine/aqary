...
class AdsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontbuil.welcome',compact('businessTypes', 'realEstateTypes', 'latests', 'mosts', 'cities', 'methodeTypesId', 'landTypesId', 'roofTypesId', 'realEstateTypesId','landId'));
    }
    ...
    public function show(Ads $ads, $id)
    {
        ...
        return view('frontbuil.adsShow', compact('ads'));
    }
...
//
    ...
    $roofTypes = \App\Category::descendantsOf( $roofTypesNode )->toTree()->pluck('name','id')->toArray();
        ...
        return view('frontbuil.main' ,compact('businessTypes', 'realEstateTypes', 'latests', 'mosts', 'cities', 'methodeTypesId', 'landTypesId', 'roofTypesId', 'realEstateTypesId','landId', 'landTypes', 'roofTypes', 'as', 'breadCrumb', 'fRequest'));
