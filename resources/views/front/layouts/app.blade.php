...
<!--===============================================================================================-->
    <link rel="icon" type="image/png" href="{!! asset('images/fashe/icons/favicon.png') !!}"/>
<!--===============================================================================================-->
...
<body class="animsition">
    ...
    <header class="header1">
        ...
        <div class="container-menu-header">
            ...
            <div class="wrap_header">
                ...
                <a href="index.html" class="logo">
                    {!! Html::image('images/fashe/icons/logo.png','IMG-LOGO') !!}
                </a>
                ...
                <div class="header-icons">
                    ...
                    <div class="header-wrapicon2">
                        {!! Html::image('images/fashe/icons/icon-header-02.png','ICON', ['class' => 'header-icon1 js-show-header-dropdown']) !!}
                            ...
                            <ul class="header-cart-wrapitem">
                                <li class="header-cart-item">
                                    <div class="header-cart-item-img">
                                        {!! Html::image('images/fashe/item-cart-01.png','IMG') !!}
                                    </div>
                                ...
                                <li class="header-cart-item">
                                    <div class="header-cart-item-img">
                                        {!! Html::image('images/fashe/item-cart-02.png','IMG') !!}
                                    </div>
                                ...
                                <li class="header-cart-item">
                                    <div class="header-cart-item-img">
                                        {!! Html::image('images/fashe/item-cart-03.png','IMG') !!}
                                    </div>
        ...
        <div class="wrap_header_mobile">
            ...
            <a href="index.html" class="logo-mobile">
                {!! Html::image('images/fashe/icons/logo.png','ICON') !!}
            </a>
    ...
    <!-- Title Page -->
    <section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(images/fashe/heading-pages-06.png);">
            ...
            <div class="row">
                <div class="col-md-4 p-b-30">
                    <div class="hov-img-zoom">
                        {!! Html::image('images/fashe/banner-14.png','IMG-ABOUT') !!}
                    </div>
                </div>
    ...
    <footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
        ...
        <div class="t-center p-l-15 p-r-15">
            <a href="#">
                {!! Html::image('images/fashe/icons/paypal.png','IMG-Paypal', ['class' => 'h-size2']) !!}
            </a>

            <a href="#">
                {!! Html::image('images/fashe/icons/visa.png','IMG-Visa', ['class' => 'h-size2']) !!}
            </a>

            <a href="#">
                {!! Html::image('images/fashe/icons/mastercard.png','IMG-mastercard', ['class' => 'h-size2']) !!}
            </a>

            <a href="#">
                {!! Html::image('images/fashe/icons/express.png','IMG-Express', ['class' => 'h-size2']) !!}
            </a>

            <a href="#">
                {!! Html::image('images/fashe/icons/discover.png','IMG-discover', ['class' => 'h-size2']) !!}
            </a>
